...
class PaymentPayslipAPITests(TestCase):
    def setUp(self):
        ...
        self.url = f"/api/businesses/{self.business.id}/payroll/payments/{self.payment.id}/payslip/"
    ...
    def test_get_payslip_for_nonexistent_payment_returns_404(self):
        response = self.client.get(f"/api/businesses/{self.business.id}/payroll/payments/9999/payslip/")
